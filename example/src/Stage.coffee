...
class Stage extends Phaser.State
  ...
  create: ->
    ...
    sprite = @add.sprite(0, 0, 'sky')
    @physics.enable(sprite, Phaser.Physics.ARCADE);
    ...
    @physics.enable(ground, Phaser.Physics.ARCADE);
    ...
    @physics.enable(ledge, Phaser.Physics.ARCADE);
  ...
  update: ->
    ...
    @physics.arcade.overlap(@player, @stars, @collectStar, null, this)
